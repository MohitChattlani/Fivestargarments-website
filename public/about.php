...
<link rel="stylesheet" type="text/css" href="stylesheet/aboutstyl.css">
		...
		<p class="para">
		The store was started almost <code>25</code> years ago by valid contributions from all the family members. Hardwork and patience has lead us here. The <kbd>motive</kbd> of the store is to provide good quality clothes for all age-groups at affordrable prices.</p>
		<p class="para">
